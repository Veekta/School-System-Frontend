    ...
    <Container>
      <Wrapper>
        <MainCard onSubmit={onSubmit}>
          <LogoTitle1>Add Student</LogoTitle1>

          <Name>
            <InputTitle>full Name</InputTitle>
            <Input placeholder="e.g: Dickson Eneh" {...register("fullName")} />
          </Name>
          ...
          <Hold>
            <PhoneData>
              <Phone>
                ...
                <Input placeholder="e.g: 5" {...register("classCode")} />
              </Phone>
            ...
            <PhoneData>
              <Phone1>
                <InputTitle>Teacher's Code</InputTitle>
                <Input placeholder="e.g: 2000" {...register("teacherCode")} />
              </Phone1>
